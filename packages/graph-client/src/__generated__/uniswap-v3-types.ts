...
export type UniV3TokenPricesQueryVariables = Exact<{
  where?: InputMaybe<Token_Filter>;
  first?: InputMaybe<Scalars['Int']['input']>;
}>;


export type UniV3TokenPricesQuery = { __typename?: 'Query', tokens: Array<{ __typename?: 'Token', id: string, derivedETH: any, totalSupply: any }>, bundle?: { __typename?: 'Bundle', ethPriceUSD: any } };


export const UniV3TokenPricesDocument = gql`
...
/**
 * __useUniV3TokenPricesQuery__
 *
 * To run a query within a React component, call `useUniV3TokenPricesQuery` and pass it any options that fit your needs.
 * When your component renders, `useUniV3TokenPricesQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useUniV3TokenPricesQuery({
 *   variables: {
 ...
 * });
 */
export function useUniV3TokenPricesQuery(baseOptions?: Apollo.QueryHookOptions<UniV3TokenPricesQuery, UniV3TokenPricesQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<UniV3TokenPricesQuery, UniV3TokenPricesQueryVariables>(UniV3TokenPricesDocument, options);
      }
export function useUniV3TokenPricesLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<UniV3TokenPricesQuery, UniV3TokenPricesQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
